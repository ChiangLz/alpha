...
<div class="container border border-secondary">
  ...
  <div class="row ">
    <div class="d-flex flex-row">
      <div> 
        <div class="menu_lateral iconos_menu degradado ">
          <a href="clientes.html"><i class="fas fa-suitcase m-3 " data-toggle="tooltip" data-placement="right" title="Clientes">
        </i>
        </a>
     ...
     <div class="d-flex justify-content-center p-3">
            <div class="border rounded p-3 text-center box_sucursal m-3">
              ...
              <form class="text-dark p-3 needs-validation"  novalidate  method="POST">
        <div class="row">
          ...
          <div  class="col-md-12 " id="grupo__nombre">
            ...
            <p class="h4">Cliente persona física:</p>
             <div class="row ">
              ...
              <div class="col-md-6 p-2">
                ...
                <input type="email" class="form-control" placeholder="telefono" name="email_contacto" required>
                 <div class="valid-feedback">
                        Correcto
                        </div>
                         <div class="invalid-feedback">
            ...
            <div class="row ">
              ...
              <div class="col-md-6 p-2">
                ...
                <input type="text" class="form-control" placeholder="telefono" name="puesto" required>
                 <div class="valid-feedback">
                        Correcto
                        </div>
                         <div class="invalid-feedback">
           ...
           <div class="row">
              <div class="col-md-6 p-2">
                ...
                <input type="text"  name="celular"class="form-control" placeholder="Telefono" required>
                <div class="valid-feedback">
                        Correcto
                        </div>
                         <div class="invalid-feedback">
    ...
    <div class="col-md-6 p-2">
        ...
        <input type="text" name="RazonSocial" class="form-control" placeholder="Ej.:Coca Cola" required />
         <div class="valid-feedback">Correcto</div>
        <div class="invalid-feedback">Por favor introduzca la Razón Social</div>
    </div>
    <div class="col-md-6 p-2">
        <label for="RazonSocial *">Dirección Fiscal *</label>
        <input type="text" name="txtDireccionfiscal" id="txtDireccionfiscal" class="form-control" placeholder="Ej.:  Av. España #123" required />
        <div class="valid-feedback">Correcto</div>
...
<div class="row">
    <div class="col-md-6 p-2">
        ...
        <input type="text" name="txtColonia" id="txtColonia" class="form-control" required  placeholder="Ej.: Fracc. Reforma" />
        <div class="valid-feedback">Correcto</div>
        <div class="invalid-feedback">Por favor introduzca la colonia</div>
    </div>
    <div class="col-md-6 p-2">
        <label for="txtCiudad *">Ciudad *</label>
        <input type="text" name="txtCiudad" id="txtCiudad" class="form-control"  required placeholder="Ej.: Veracruz" />
        <div class="valid-feedback">Correcto</div>
...
<div class="row">
    <div class="col-md-6 p-2">
        ...
        <input type="text" name="txtEstado" id="txtEstado" class="form-control"  required placeholder="Ej.: Veracruz" />
        <div class="valid-feedback">Correcto</div>
        <div class="invalid-feedback">Por favor introduzca el estado</div>
    </div>
    <div class="col-md-6 p-2">
        <label for="txtCp *">Código Postal *</label>
        <input type="text" name="txtCp" id="txtCp" class="form-control"  required placeholder="Ej.: 91919" />
        <div class="valid-feedback">Correcto</div>
...
<div class="row">
    <div class="col-md-6 p-2">
        ...
        <input type="text" name="txtRfc" id="txtRfc" class="form-control"  required placeholder="Ej.: MUJI701020ABC" />
        <div class="valid-feedback">Correcto</div>
        <div class="invalid-feedback">Por favor introduzca el RFC</div>
    </div>
    <div class="col-md-6 p-2">
                <label for="email2"> Email *</label>
                <input type="text"  name="email2" class="form-control" placeholder="Email" required>
                <div class="valid-feedback">
                        Correcto
                        </div>
                         <div class="invalid-feedback">
...
<div class="row">
    ...
    <button type="submit" class="btn btn-primary  btn-lg btn-block m-3">Enviar Forma</button>
