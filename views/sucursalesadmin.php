...
if($_SESSION['rol']==="SuperAdministrador"){
  $col= new consul();
  $detalleSuc = $col->sucursaladm($_SESSION['ids']);
  $col1= new consul();
    ...
    <div class="d-flex flex-row">
      ...
      <div class=""> 
       ...
       <?php foreach ($detalleSuc as $row2) { ?>
            <div class="border rounded p-3 text-center box_sucursal m-3" >
              <i class="fas fa-building fa-4x m-3 rojo_obscuro"></i>
              <p class="font-weight-bold h5">Sucursal <br> <?php echo $row2['nomsuc']; ?></p> <br>
              <p class="font-weight-bold "><?php echo $row2['dirsuc']; ?></p>            
            </div>
        <?php }?>
